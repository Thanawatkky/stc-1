...
<nav class="navbar navbar-expand-lg bg-light sticky-top">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item" href="index.php?p=user_manager">จัดการผู้ใช้งาน</a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="index.php?p=shop_manager">จัดการร้านอาหาร</a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="index.php?p=rider_manager">จัดการไรเดอร์</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a href="#" class="nav-link active fs-5"  data-bs-toggle="modal" data-bs-target="#modal-addShopType">เพิ่มประเภทร้านอาหาร</a>
                    </li>
    ...
    <div class="modal" id="modal-addShopType" tabindex="-1" aria-labelledby="ShopTypeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="ShopTypeModalLabel">เพิ่มประเภทร้านอาหาร</h3>
